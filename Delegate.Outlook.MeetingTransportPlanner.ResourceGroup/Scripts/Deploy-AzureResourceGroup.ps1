...
Param(
    ...
    [string] $ResourceGroupName = 'Delegate.Outlook.MeetingTransportPlanner',
    [switch] $UploadArtifacts,
    [string] $StorageAccountName,
    [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
    [string] $TemplateFile = '..\Templates\WebSiteCDN.json',
    [string] $TemplateParametersFile = '..\Templates\WebSiteCDN.parameters.json',
